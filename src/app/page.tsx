...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-6 bg-gradient-to-b from-black to-[#0a0b0f]">
      {/* Top section with sign up button */}
      <div className="w-full flex justify-end">
        <button
          onClick={() => navigateTo('/signup')}
          className="bg-gradient-to-r from-cyan-500 to-blue-500 text-white px-6 py-2 rounded-full font-medium hover:opacity-90 transition-opacity shadow-lg"
        >
        ...
        <div className="text-center mb-10">
          ...
          <div className="relative h-16 mb-6">
            {features.map((feature, index) => (
              ...
              >
                <h2 className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500 flex items-center justify-center">
                  <svg
        ...
        <div className="container mx-auto max-w-lg text-center">
          ...
          <div className="flex justify-center items-center gap-6 pt-2">
            <button 
              ...
              className="text-blue-400 hover:text-blue-300 underline text-base font-medium flex items-center whitespace-nowrap"
            >
